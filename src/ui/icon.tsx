...
export const I: Record<string, string> = {
  ...
  camera: "M4 8h3.2L9.5 5.5h5L16.8 8H20v11H4zM12 10.5a3.6 3.6 0 100 7.2 3.6 3.6 0 000-7.2z",
  refresh: "M4.5 12a7.5 7.5 0 0113-5.1M19.5 12a7.5 7.5 0 01-13 5.1M19 4.5v4h-4M5 19.5v-4h4",
  gallery: "M4 5h16v14H4zM4 15.5l4.5-4.5 3.5 3.5 3-3 5 5M9 10a1.3 1.3 0 100-2.6A1.3 1.3 0 009 10z",
};
